...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="intro-section single-cover" id="home-section">
      ...
      <div class="slide-1 text-white" style="background-image: url('../../../images/bgmtk.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">Matematika</h1>
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            ...
            <div class="mb-5">
              ...
              <p>Syukur alhamdulillah penulis panjatkan ke hadirat Allah SWT., karena hidayah dan inayah-Nya penulisan weebsite ini dapat terselesaikan dengan waktu yang telah ditetapkan. Matematika adalah bahasa universal dan karenanya kemampuan matematika siswa suatu negara sangat mudah dibandingkan dengan negara lain. Selain dari itu, matematika juga dipakai sebagai alat ukur untuk menentukan kemajuan pendidikan di suatu negara. 
Kita mengenal PISA (Program for International Student Assessment) dan TIMSS (The International Mathematics and Science Survey) yang secara berkala mengukur dan membandingkan antara lain kemajuan pendidikan matematika di beberapa negara. Standar internasional semacam ini memberikan arahan dalam merumuskan pembelajaran matematika di SMP/MTs. Hasil pembandingan antara yang kita ajarkan selama ini dengan yang dinilai secara internasional menunjukkan adanya perbedaan, baik terkait materi maupun kompetensi. Perbedaaan ini menjadi dasar dalam merumuskan pembelajaran Matematika dalam Kurikulum 2013.
.</p>
            </div>
          ...
          <div class="col-lg-4 pl-lg-5">
            <div class="mb-5 text-center border rounded course-instructor">
              ...
              <div class="mb-4 text-center">
                ...
                <h3 class="h5 text-black mb-4">Haris, S.Pd</h3>
                <p>Pada setiap Membelajarkan mengikuti pendekatan
ilmiah, yaitu mengamati, menanya, menggali informasi, menalar, dan
mngkomunikasikan yang disajikan dengan ikon-ikon tertentu, yaitu Ayo Kita
Amati, Ayo Kita Menanya, Ayo Kita Menggali Informasi/Sedikit Informasi/
Ayo Kita Mencoba, dan Ayo Kita Berbagi</p>
              </div>
            </div>
          </div>
