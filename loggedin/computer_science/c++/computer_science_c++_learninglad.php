...
<title>BeeSmarts</title>
 ...
 <nav aria-label="breadcrumb">
  <ol class="breadcrumb" style="background:linear-gradient(to right,rgba(100,150,150, 1),rgba(150, 150, 150, 1))">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="../../all_courses.php" style="color:white;font-size:bold;">Kursus</a></li>
    <li class="breadcrumb-item active" aria-current="page" style="color:white;">Bahasa Indonesia</li>
...
<!-- the actual content of this course (  Learn C++ Programming | Video Tutorial for Beginners)
  ...
  <div class="card">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
        <a href="actualvideocontent_learninglad.php?video=1">&#10170  Bab 1 : Belajar Mendeskripsikan</a><br>
        <a href="actualvideocontent_learninglad.php?video=2">&#10170  Bab 2 : Memahami dan Mencipta Cerita Fantasi</a><br>
        <a href="actualvideocontent_learninglad.php?video=3">&#10170  Bab 3 : Mewariskan Budaya Melalui Teks Prosedur</a><br>
        <a href="actualvideocontent_learninglad.php?video=4">&#10170  Bab 4 : Menyibak Ilmu dalam Laporan Hasil Observasi</a><br>
      </div>
    </div>
  </div>
  <!-- Détails chapitre 1 -->
